...
The performance enhancement brought about by the CoT prompt generators is evident when compared to the non-CoT prompt version, with a relative gain of 16.39\%. This finding highlights the significance of CoT prompt generators in augmenting the efficacy of the CoT-SelfEvolve model.
...
Driven by the understanding that the activation of large LLMs, such as GPT-4 or Claude 3, is quite costly, particularly when multiple runs of the self-correction code generator are permitted, we embarked on an experiment to assess the effect of utilizing a large LLM to steer the code generation process while employing a smaller LLM for actual code production. The findings of this study are depicted in Table~\ref{tab:cot_selfevolve_ds1000_results_ablation_2}. It's clear that the use of a larger LLM to guide the code generation process can notably augment the model's performance, evidenced by a relative gain of 11.26\%.
...
\begin{table}[H]
    ...
    \resizebox{\columnwidth}{!}{%
        \begin{tabular}{|l|c|c|c|c|c|c|c|}
            ...
            GPT-3.5 CoT + Code       & 32.08                      & 72.06                        & 66.09                        & 32.26                           & 29.55                       & 17.73                      & 46.67                           \\ \hline
